...
We are using large datasets from Inside Airbnb.
...
San Francisco listings: Download here
San Diego listings: Download here
...
│   ├── model_performance_report.pdf  # Model comparison report
...
✅ X_train.csv, X_test.csv, y_train.csv, y_test.csv - Train-test splits
...
# Windows
mkdir data\raw data\processed data\external notebooks\week1 notebooks\week2 notebooks\week3 src models reports\figures references

# Mac/Linux
mkdir -p data/raw data/processed data/external notebooks/week1 notebooks/week2 notebooks/week3 src models reports/figures references
...
Open your notebook in notebooks/week1/ and start working!
...
10. Project Links
GitHub Repository: https://github.com/MuhammedFatihAsan/ML-Project
Project Board: https://github.com/users/MuhammedFatihAsan/projects/6/views/1
Inside Airbnb Data Source: http://insideairbnb.com/get-the-data/
11. References
